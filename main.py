...
parser.add_argument('--log-interval', type=int, default=500, metavar='STEPS', help='Number of training steps between logging status')
...
while T < args.evaluation_size:
  ...
  val_mem.append(state, action, None, done)
  state = next_state
  T += 1
